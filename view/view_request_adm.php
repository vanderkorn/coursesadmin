...
<tr><th>Назначенный УМК</th><th>Назначенный  преподаватель</th><th>УМК</th><th>Преподаватель</th></tr>
<tr ><form action="<?php echo $_SERVER['PHP_SELF'];?>" method="POST"  name="self" ><td><input type="submit" name="select" value="Выбрать"></td><td>От: <input type="text" name="num0" size="5"><br>До: <input type="text" name="num1"  size="5"><br></td>
<td ><select name="status_umk">
...
<td>От: <input type="text" name="date_create0" size="10"><br>До: <input type="text" name="date_create1"  size="10"><br></td><td><select name="branch"  style="width:100px">
...
<?php }?>
</select><br></td><td><input type="text" name="category"  size="10"><br></td><td><select name="subject"  style="width:100px">
<option  value="-1"></option>";
